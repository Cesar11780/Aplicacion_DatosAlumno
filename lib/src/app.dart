        ...
        flexibleSpace: Container(
          decoration: const BoxDecoration(
            image: DecorationImage(
                image: AssetImage('assets/images/galaxia.jpg'),
                fit: BoxFit.fill),
          ),
        ),
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  MyCard(
                    ...
                    title: const Text("Nombre: Cesar Ramirez Cuevas",
                    ...
                    fondo: const Text("Edad: 21 años",
                        style: TextStyle(color: Colors.orange, fontSize: 20.0)),
                    parrafo: const Text(
                        "Email: cesar.ramirezcuevas@utxicotepec.edu.mx",
                        style: TextStyle(color: Colors.orange, fontSize: 20.0)),
                  ),
                ],
              ),
              MyCard(
                ...
                fondo: const Text("Tutor: MTI Marco Antonio Ramirez Hernandez",
                    style: TextStyle(color: Colors.orange, fontSize: 20.0)),
                parrafo: const Text("Docente de la Universidad de Xicotepec de Juarez",
                    style: TextStyle(color: Colors.orange, fontSize: 20.0)),
              ),
                MyCard(
                title: const Text(
              ...
              MyCard(
                ...
                MyCard(
                title: const Text("Materia: Ingles IX",
                    style: TextStyle(color: Colors.orange, fontSize: 20.0)),
                imagen: const Text("Docente: Ing. Lisbeth ",
                    style: TextStyle(color: Colors.orange, fontSize: 20.0)),
